...
namespace ManageEmployee.Migrations
{
    ...
    [Migration("20241031034021_EditIssuedByProvinceToDiploma")]
    partial class EditIssuedByProvinceToDiploma
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ManageEmployee.Models.Diploma", b =>
                {
                    ...
                    b.Property<int>("IssuedByProvinceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ManageEmployee.Models.Diploma", b =>
                {
                    ...
                    b.HasOne("ManageEmployee.Models.Province", "IssuedByProvince")
                        .WithMany()
                        .HasForeignKey("IssuedByProvinceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Employee");

                    b.Navigation("IssuedByProvince");
                });
